...
class HomeViewController: UIViewController {
    ...
    private func addConstraints() {
        ...
        card1.bottom(to: card1Label, offset: 20, relation: .equalOrGreater)
        card1.bottom(to: card1Icon, offset: 20, relation: .equalOrGreater)
        card1Icon.height(80)
        ...
        card2.bottom(to: card2Label, offset: 20, relation: .equalOrGreater)
        card2.bottom(to: card2Icon, offset: 20, relation: .equalOrGreater)
        card2Icon.height(80)
        ...
        card3.bottom(to: card3Label, offset: 20, relation: .equalOrGreater)
        card3.bottom(to: card3Icon, offset: 20, relation: .equalOrGreater)
        card3Icon.height(80)
